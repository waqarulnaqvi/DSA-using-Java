package com.company;
import java.util.*;
public class pt_72_cwh_91_Advance_java_ch_1_Array_List_quick_quiz_8 {
    public static void main(String[] args) {
        ...
        //An ArrayList has an initial capacity which is simply the size of the array used to store the elements in the list.When you create an ArrayList you can specify the initial capacity.
        //for example:-
        ArrayList<Integer> l2 =new ArrayList<>(5);//ArrayList is a modified array..
...
//        l1.addLast(111111224);//Error : special method only is in the linklist not in the array list..
//        l1.addFirst(7946);///Error : special method only is in the linklist not in the array list..
//        l1.addLast(115454224);//Error : special method only is in the linklist not in the array list..
//        l1.addFirst(454541112);//Error : special method only is in the linklist not in the array list..
//        l1.removeFirst();//Error : special method only is in the linklist not in the array list..
//        l1.removeFirst();//Error : special method only is in the linklist not in the array list..
//        l1.removeLast();//Error : special method only is in the linklist not in the array list..
//        l1.removeLast();//Error : special method only is in the linklist not in the array list..
